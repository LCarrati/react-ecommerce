...
const PageCart = () => {
  ...
  return ( //Verificar se existem itens no carrinho
    cart.length>0 ? 
      (<Wrapper>  
        ...
        <div className='checkoutButtonArea'>
          <div><Link to={'/emconstrucao'}><Button label={'Finalizar compra'} icon ={<FaCheck />}/></Link></div>
        </div> 
      </Wrapper>) 
    : (<Empty className='empty'><p>Carrinho vazio</p></Empty>) 
  )
}
